...
<nav class="navbar navbar-inverse bg-primary" style="  background-color: #000011;border-color: #CCFFCC;">
											...
											do{
												echo '
													...
													<div class="list-item col-md-3 col-6 mt-2">
														<a href="show.php?ididol='.$detail2['ididol'].'" class="list-item-link" style="text-decoration: none;" >
															<div class="anh" style="border-radius: 12px;">
    ...
    <div class="thanhcc">
            <ul>
                <center>
                    <li><a style="text-decoration: none; color:white;" href="#"><b><font size="3">Đầu trang</font></b></a></li>
